...
class ConfigLoader {
    ...
    loadFromWindow() {
        try {
            ...
            if (legacyRules.length > 0 && this.config) {
                ...
                if ((legacyConfig === null || legacyConfig === void 0 ? void 0 : legacyConfig.collectorUrl) && this.config.trackEndpoint === `${this.BASE_API_URL}/event`) {
    ...
    adaptLegacyConfig() {
        ...
        return legacyConfig.rules.map((rule, index) => ({
            id: baseId + index,
