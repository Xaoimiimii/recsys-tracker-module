...
export class RatingNormalizer {
     ...
     */
    public normalize(value: number, container: Element, maxRatingOverride?: number): { normalized: number, max: number, type: string } {
    ...
    private detectMaxRating(container: Element, currentValue: number): number | null {
    ...
    private isBinaryRating(container: Element): boolean {
